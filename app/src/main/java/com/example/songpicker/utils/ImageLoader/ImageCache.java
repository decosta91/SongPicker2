...
import com.example.songpicker.utils.GeneralUtils;
...
public class ImageCache {
    ...
    final Object mReusableBitmapsLock = new Integer(1);
...
//                        }
    ...
    private static boolean canUseForInBitmap(
        ...
        int width = targetOptions.outWidth /
                (targetOptions.inSampleSize == 0 ? 1 : targetOptions.inSampleSize);
    ...
    public static boolean isExternalStorageRemovable() {
        if (GeneralUtils.hasGingerbread()) {
